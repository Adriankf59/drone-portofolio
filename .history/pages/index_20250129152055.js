...
import { ArrowLeftIcon, ArrowRightIcon } from '@heroicons/react/20/solid'; // Adjust with correct path for v2
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="max-w-7xl mx-auto my-10">
        ...
        <div className="flex justify-between mt-4">
          <button onClick={handlePrevPage} className="flex items-center px-4 py-2 bg-gray-300 rounded disabled:opacity-50" disabled={portfolioPage === 0}>
            <ArrowLeftIcon className="h-5 w-5 mr-2" />
            Previous
          </button>
          <button onClick={handleNextPage} className="flex items-center px-4 py-2 bg-gray-300 rounded disabled:opacity-50" disabled={(portfolioPage + 1) * pageSize >= portfolios.length}>
            Next
