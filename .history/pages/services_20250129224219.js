...
const services = [
  ...
  },
  {
    ...
    price: "Rp350.000 per event",
    image: "/images/DJI_0651.JPG",
  },
];
  ...
  return (
    <div className="bg-white font-sans min-h-screen">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/new-background.jpg')" }} // Correct the path here if needed
      >
        <div className="max-w-4xl text-black mx-auto text-center bg-white bg-opacity-60 p-6 rounded">
      ...
      <section className="bg-gray-200 py-10">
        <div className="max-w-4xl text-black mx-auto text-center mb-6">
        ...
        <form className="max-w-2xl text-black mx-auto px-4">
          <input
            type="text"
