      ...
      <nav className="max-w-7xl mx-auto flex justify-between items-center p-5">
        <div className="flex items-center space-x-4">
          <Image
            ...
            width={4} // Adjust the width according to your needs
            height={50} // Adjust the height according to your needs
          />
          <h1 className="text-xl text-black">Uber Aerials</h1> {/* Optional: Keep the text if you want to display it alongside the image */}
        </div>
